...
using SmartPlugService.Application.Constants;
using SmartPlugService.Application.DTOs;
using SmartPlugService.Application.Interfaces;
using SmartPlugService.Domain.Entities;
using SmartPlugService.Domain.Interfaces;

namespace SmartPlugService.Application.Services;
...
public partial class CompanyAppService(
    ...
    IEntityRepository<Sensor> sensorRepository,
    ...
    ILogger<CompanyAppService> logger)
{
    ...
    private readonly IEntityRepository<Sensor> _sensorRepository = sensorRepository;
